...
The [R package](https://github.com/PLAY-behaviorome/databraryapi) could and should be expanded to include Python and possibly Julia.
...
- To instantiates volume and person management functionality of the Profile page in Databrary 1.0.
...
- Eliminate "timeline" interface and replace with a file list that can be sorted  by file type.
...
- Expand the search engine to include all fields contained in the spreadsheet.

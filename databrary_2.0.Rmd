...
- Right now an Authorized Investigator should be adding affiliates. However a Manager can add affiliates as their own affiliate. This needs to be changed so that Manager access can add affiliates on behalf of their Authorized investigator. Affiliates should not have their own affiliates.

...
- Components
    + For *collaborators* only, clickable view (eyeball icon) and edit (pencil icon) buttons to switch between modes. A clickable *volume history* button to show the edit history on a volume.
